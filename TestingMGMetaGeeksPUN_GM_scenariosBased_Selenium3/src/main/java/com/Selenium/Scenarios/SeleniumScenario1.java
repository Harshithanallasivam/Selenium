...
public class SeleniumScenario1 {
	WebDriver driver;
	...
	public List <String> searchOptions() throws InterruptedException{
		...
		List<WebElement> options = driver.findElements(By.xpath("/html/body/div[1]/div[3]/form/div[1]/div[1]/div[2]/div[4]/div[2]/div[1]/div/ul/li[2]"));
	...
	public List<WebElement> Extract_Table_Data(){
		driver.get("https://www.w3schools.co/html/html_tables.asp");
	...
	public void DragAndDrop() throws InterruptedException {
		...
		Thread.sleep(2000);
		act1.dragAndDrop(scrElement,destElement).perform();
		
		act1.clickAndHold(scrElement).moveToElement(destElement).release().perform();
		act1.clickAndHold(scrElement).moveToElement(destElement).release().build().perform();
